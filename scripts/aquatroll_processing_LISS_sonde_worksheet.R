...
path.p              <- "C:/Users/samjg/Documents/Github_repositories/LISS_sonde_data/data/csv" #the location of all your respirometry files 
...
write.csv(cumulative.summary.table, "C:/Users/samjg/Documents/Github_repositories/LISS_sonde_data/output/summary_aquatroll.csv")
